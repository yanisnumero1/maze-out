...
export interface NightTable { id: string; number: string; display_number?: number | null; zone_id: string; head_waiter_id: string | null; standard_capacity: number; status: TableStatus; position_x: number; position_y: number; active: boolean }
