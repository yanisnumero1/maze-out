...
export interface TableVisit { id: string; night_session_id: string; table_id: string; current_table_id?: string | null; zone_id: string; head_waiter_id: string | null; present_people: number; extra_guests: number; comment: string | null; arrived_at: string; ended_at: string | null; sale_number?: number | null; zone: Zone; head_waiter: HeadWaiter | null }
