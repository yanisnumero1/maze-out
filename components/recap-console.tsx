...
import { activitySummary, businessReferrerRanking, cdrVisitNotes, promoterTotal, recapAnalytics, recapRotations, recapTables, recapWaiters, recapZones, selectedNightNotes, totalClubEntryCount } from '@/lib/recap';
...
export function RecapConsole() {
  ...
  const businessReferrers = useMemo(() => businessReferrerRanking(visits), [visits]);
