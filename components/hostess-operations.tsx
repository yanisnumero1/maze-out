...
import { actorProfileMap, formatActorLabel } from '@/lib/actors';
...
export function HostessOperations({ view }: { view: OperationView }) {
  ...
  async function refresh() {
    ...
    setAuditRows(audits);
    const actorIds = [...new Set(audits.map((audit) => audit.actor_id).filter(Boolean))];
