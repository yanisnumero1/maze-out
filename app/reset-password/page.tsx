  ...
  return (
    <section className="auth-shell">
      <div className="w-full max-w-sm">
        <Image src="/bridge-logo.svg" alt="BRIDGE — Pont Alexandre III" width={480} height={112} priority className="mx-auto mb-8 w-56" />
        <div className="panel auth-card">
          ...
          {mode === 'request' ? <form className="mt-6 space-y-4" onSubmit={(event) => { event.preventDefault(); void requestReset(); }}>
            ...
            <button className="primary-button w-full" disabled={submitting}>{submitting ? 'Envoi en cours...' : 'Envoyer le lien de réinitialisation'}</button>
            ...
            <button className="primary-button w-full" disabled={submitting}>{submitting ? 'Mise à jour...' : 'Définir le mot de passe'}</button>
          </form>}
